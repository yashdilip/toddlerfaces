  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        { heading: "Where media lives", body: "Original photos and videos should remain in external storage providers such as Google Drive, S3, Dropbox, OneDrive, or photographer-hosted galleries. Toddlerfaces stores references and metadata, not long-term original media." },
        { heading: "How we use data", items: ["Authenticate users and enforce role-based access.", "Organize child albums and media references.", "Apply private, shared, and public visibility rules.", "Record legal attestations and approval workflows.", "Support moderation, safety, abuse reporting, and account protection."] },
      ]}
    />
  )
}
