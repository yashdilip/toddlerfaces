...
export default function Terms() {
  return (
    <LegalPage
      ...
      sections={[
        { heading: "Adult accounts only", body: "Users must provide birth month and birth year and attest they are adults. Admin accounts cannot be created through public signup." },
